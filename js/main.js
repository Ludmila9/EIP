...
$('.links-slider').slick({
	...
	cssEase: 'ease-out',
	speed: 1500,
	appendDots: '.links-slider__dots',
	prevArrow: '.links-prev__arr',
	nextArrow: '.links-next__arr',
});
// sliders - end

// tab - start

$(document).on("click", ".steps__item", function() {
	var numberIndex = $(this).index();

	if (!$(this).is("active")) {
		$(".steps__item").removeClass("active");
		$(".steps-list__about").removeClass("active");

		$(this).addClass("active");
		$(".steps-list__content").find(".steps-list__about:eq(" + numberIndex + ")").addClass("active");

		var listItemHeight = $(".steps-list__content")
			.find(".steps-list__about:eq(" + numberIndex + ")")
			.innerHeight();
		$(".steps-list__content").height(listItemHeight + "px");
	}
});
